---
name: fix-bug
description: Structured bug fix — reproduce, locate, diagnose, fix, verify — with rabbit-hole prevention after 3 attempts. Use for one specific reported bug. NOT hunting for unknown bugs (use /grill or /review-changes); NOT a cleanup sweep (use /techdebt).
---
